...
public class ClsService {
	...
	public void ex2() {
		...
		// schoolname을 name으로 바꾸면 에러남 왜? private이라서
	...
	public void ex3() {
		...
		// ==> 클래스에서 메서드에 getter/setter 아직 안하면 간접 접근 불가능
		...
		//			같은 기본생성자로 User객체 생성했기 떄문
		
		// 해결방법 1 : setter을 이용해서 새로운 값을 대입
		...
		User u4 = new User("fhsiah", "ewoihwe"
				);
