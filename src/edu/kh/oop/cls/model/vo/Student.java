...
//[접근제한자] [예약어] class 클래스 명
	//class라고 쓰는건 다 객체로 만들겠다는 것
	
// 접근제한자 public : 같은 프로젝트 내에서 어떤 클래서에서든 import 할 수 있음을 나타냄

	//필드(field) : 객체의 속성을 작성하는 클래스 내부 영역
	// == 멤버변수를 작성하는 곳 : 메서드 밖에 작성 된 변수
	 ...
	 * 
	 * */
	// => 필드에 접근제한자는 : 직접 접근 가능한 범위를 나타냄.
	
	public int v1 = 10;
	protected int v2 = 20;
	int v3 = 30;
	//특별한 경우가 아니면 대부분 private 사용
	private int v4 = 40;
...
//==========================================================	
	...
	private String name;//캡슐화 원칙 private -> 간접접근방법 필요
	...
	/* - new 연산자를 통해서 객체를 생성 할 때
	 * 	생성 된 객체의 필드 값 초기화 + 지정된 기능을 수행하는 역할
	 * 
	 * -생성자 작성 규칙
	 * 1) 생성자의 이름은 반드시 클래스명과 같아야 한다
	 * 2) 반환형이 존재하지 않는다 (void 같은거)
	 * 
	 * - 생성자 종류
	 * 1) 기본 생성자
	 * 2) 매개변수 생성자
